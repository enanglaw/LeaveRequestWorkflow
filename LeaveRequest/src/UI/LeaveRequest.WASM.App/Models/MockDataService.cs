...
namespace LeaveRequest.WASM.App.Models
{
    public class MockDataService
    {
        ...
        private static List<Employee> InitializeMockEmployees()
        {
            var e1 = new Employee
            {
                ...
                City = "Lagos",
                Email = "awase.faustina@gmail.com",
                EmployeeId = 1,
                FirstName = "Faustina",
                LastName = "Awase",
            ...
            var e2 = new Employee
            {
                ...
                BirthDate = new DateTime(1986, 4, 12),
                City = "Lagos",
                Email = "enanglaw@gmail.com",
                EmployeeId = 2,
                FirstName = "Lawrence",
                LastName = "Enang",
                Gender = Gender.Male,
                PhoneNumber = "08165335282",
                Smoker = false,
                Street = "New Street",
                Zip = "2000",
            ...
            {
                MaritalStatus = MaritalStatus.Married,
                BirthDate = new DateTime(1993, 5, 7),
                City = "Lagos",
                Email = "awase.confidence@gmail.com",
                EmployeeId = 2,
                FirstName = "Awase",
                LastName = "Confidence",
                Gender = Gender.Female,
        ...
        private static List<Country> InitializeMockCountries()
        {
            return new List<Country>
            {
                ...
                new Country {CountryId = 8, Name = "Brazil"},
                 new Country {CountryId = 9, Name = "Nigeria"}
            };
        }
    }
}
