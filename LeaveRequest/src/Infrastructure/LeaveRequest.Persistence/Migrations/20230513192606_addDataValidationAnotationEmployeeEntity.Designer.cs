...
namespace LeaveRequest.Persistence.Migrations
{
    ...
    [Migration("20230513192606_addDataValidationAnotationEmployeeEntity")]
    partial class addDataValidationAnotationEmployeeEntity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LeaveRequest.Domain.Entity.Country", b =>
                {
            ...
            modelBuilder.Entity("LeaveRequest.Domain.Entity.Employee", b =>
                {
            ...
            modelBuilder.Entity("LeaveRequest.Domain.Entity.JobCategory", b =>
                {
                    b.Property<int>("JobCategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LeaveRequest.Domain.Entity.Employee", b =>
                {
                    b.HasOne("LeaveRequest.Domain.Entity.Country", "Country")
                        .WithMany()
                        .HasForeignKey("CountryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LeaveRequest.Domain.Entity.JobCategory", "JobCategory")
                        .WithMany()
